...
export default function MarketsPage() {
  ...
  const fetchMarket = async() => {
    ...
    if(shop){
      ...
      setMarkets(res.data.market.market)
    }
  }
                        ...
                        markets === undefined ? (
                          ...
                          markets.map((market) => (
                            ...
                            >
                              <td className="pl-6">
                                <img
                                    src={`https://flagicons.lipis.dev/flags/4x3/${market.country.toLowerCase()}.svg`}
                                    alt={market.country}
                                    className="w-8 h-7 inline-block border border-white rounded-md"
                                  />                              
                                </td>
                              <td className="h-12 flex items-center pr-6 py-2">
                                <div>
                                  <div className="font-medium">
                                    {countryOptions.find(opt => opt.value === market.country)?.label || market.country}
                                  </div>
                                  {market.primary && (
          ...
          >
            <Modal.Section>
              <div className="flex flex-col gap-4">
                ...
                <Banner status="info" title="" className="mt-2">
                  <Text as="span" variant="bodySm">
                    The popup for markets (countries) and their respective
                    languages will only be displayed if the countries are set up
                    in the Shopify Markets.
                  </Text>
                </Banner>
              </div>
            </Modal.Section>
