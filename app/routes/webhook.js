...
const htmlData = `<div style="background-color: rgb(149, 154, 163); width: 100%; padding: 3rem;"><div style="display: flex; justify-content: center; align-items: center; width: 100%;"><div style="box-shadow: rgba(0, 0, 0, 0.1) 0px 4px 6px; display: flex; flex-direction: row; width: 620px; height: 400px; border: 1px solid rgb(78, 24, 24); border-radius: 20px; background-color: rgb(255, 255, 255); opacity: 1;"><div style="width: 45%; display: flex; justify-content: center; align-items: center;"><img src="/app/image/background_image.png" alt="Popup background" style="width: 100%; height: 100%; object-fit: cover; border-top-left-radius: 20px; border-bottom-left-radius: 20px;"></div><div style="width: 55%; padding: 0.5rem 1rem 1rem; display: flex; flex-direction: column; align-items: center; margin-left: 1rem; text-align: center;"><div style="display: flex; justify-content: center; align-items: center; margin: 1rem 1rem 1.2rem; width: 100px; height: 100px;"><img src="/app/image/logo.png" alt="Popup Logo" style="width: 100%; height: 100%; object-fit: cover; border-radius: 9999px;"></div><span style="display: block; font-weight: 400; font-size: 35px; font-family: serif; color: rgb(83, 80, 80); margin-bottom: 20px;">Welcome!</span><span style="display: inline-block; font-weight: 100; font-size: 14px; font-family: sans-serif; color: rgb(141, 134, 134); line-height: 2;">Please verify that you are 18 years of age or older to enter this site.</span><div style="margin-top: 1rem; width: 100%; display: flex;"><div style="display: flex; column-gap: 1rem; justify-content: center; align-items: center; width: 100%;"><button id="acceptButton" style="transform: scale(1); transition: transform 0.1s; font-size: 14px; color: rgb(255, 255, 255); background-color: rgb(0, 127, 95); border-width: 1px; border-color: rgb(0, 127, 95); border-radius: 6px; font-weight: 500; font-family: sans-serif; padding: 0.6rem 1.5rem; width: fit-content;">Yes, I’m under 18</button><button id="rejectButton" style="transform: scale(1); transition: transform 0.1s; font-size: 14px; color: rgb(0, 0, 0); background-color: rgb(204, 204, 204); border-width: 1px; border-color: rgb(204, 204, 204); border-radius: 6px; font-weight: 100; font-family: sans-serif; padding: 0.6rem 1.5rem; width: fit-content;">No, I’m over 18</button></div></div><div style="margin-top: 1.25rem;"></div></div></div></div></div>`;
